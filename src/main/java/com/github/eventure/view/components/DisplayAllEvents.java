...
public class DisplayAllEvents extends JPanel{
public DisplayAllEvents(MainPage mainPage){
    setLayout(null);
    ...
    JLabel label = new JLabel("Todos os Eventos", SwingConstants.CENTER);
    ...
    eventos = eventController.getAllEvents();
    int cardWidth = 300;
    int cardHeight = 240;
    int spaceX = 20;
    int spaceY = 20;
    ...
    int rows = (int) Math.ceil(eventos.size() / (double) cardsPerRow);
