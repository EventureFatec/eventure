...
public class DeleteAllEventPanel extends JPanel{
    public DeleteAllEventPanel(MainPage mainPage) {
        setLayout(null);
        ...
        JLabel label = new JLabel("Escolha um Evento Para Excluir", SwingConstants.CENTER);
        ...
        for (int i = 0; i < user.getMyEventsList().size(); i++) {
            ...
            EventPanelForDelete panel = new EventPanelForDelete(
                event.getTitle(),
